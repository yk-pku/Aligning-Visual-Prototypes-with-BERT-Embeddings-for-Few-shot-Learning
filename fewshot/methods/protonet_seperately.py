...
class ProtoNet_seperately(nn.Module):
    def __init__(self, model_func, n_way, n_support, text_vector_dimension, output_dimension,
                visual_net_parameters, text_net_parameters,
                cosine = False, initial = True, lam = 0, result_way = 0, loss_lam = 1):
        super(ProtoNet_seperately, self).__init__()
    ...
    def set_forward(self, x, text_vector, is_feature = False):
        ...
        cosine_dists = cosine_dist(z_query, text_feature)
